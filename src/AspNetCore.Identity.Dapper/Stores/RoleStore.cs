...
public class RoleStore(IDatabaseConnectionFactory databaseConnectionFactory) : 
    IQueryableRoleStore<ApplicationRole>, IRoleClaimStore<ApplicationRole>, IRoleStore<ApplicationRole>
{
    ...
    public Task<ApplicationRole?> FindByIdAsync(string roleId, CancellationToken cancellationToken)
    {
        ...
        return !isValidGuid
            ...
            : _rolesTable.FindByIdAsync(roleGuid);
    }
    ...
    public async Task<IList<Claim>> GetClaimsAsync(ApplicationRole role, CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
        role.ThrowIfNull(nameof(role));
        role.Claims ??= [.. (await _roleClaimsTable.GetClaimsAsync(role.Id))];
        return role.Claims;
    }
